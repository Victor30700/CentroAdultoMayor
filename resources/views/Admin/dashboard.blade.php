...
<script>
    ...
    function viewUser(userCi) {
        ...
        // Aquí puedes hacer una petición AJAX para obtener los detalles del usuario
        ...
        //                     <strong>Fecha registro:</strong> ${data.created_at}<br>
        //                 </div>
        //             </div>
        //         `;
        //     })
        ...
        content.innerHTML = `
            <div class="alert alert-info">
                ...
                Detalles del usuario con CI: ${userCi}
    ...
    document.addEventListener('DOMContentLoaded', function() {
        // Agregar confirmación a formularios de eliminación
