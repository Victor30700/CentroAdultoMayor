                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xl-12">
                            <div class="card overflow-hidden">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="{{ route('admin.store-adulto-mayor') }}" method="POST" id="registerAdultoMayorForm" novalidate>
                                        @csrf
                                            ...
                                            <div class="tab-pane fade" id="datosAdultoMayor" role="tabpanel" aria-labelledby="datos-adulto-mayor-tab">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4 mb-3">
                                                        ...
                                                        <small class="form-text text-muted">Número único de identificación del caso (opcional, se puede asignar automáticamente).</small>
                                                    </div>
                                                    <div class="col-md-4 mb-3">
                                                ...
                                                <div class="row">
                                                    <div class="col-12 mb-3">
                                                        <div class="alert alert-info">
                                                            <strong><i class="fe fe-info"></i> Información importante:</strong>
                                                            <ul class="mb-0 mt-2">
                                                                <li>Los adultos mayores registrados <strong>no tendrán acceso al sistema</strong>.</li>
                                                                <li>Esta información será utilizada únicamente para brindar servicios y seguimiento.</li>
                                                                <li>Los datos serán manejados con total confidencialidad según las políticas de privacidad.</li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                </div>
