            ...
            <div class="side-app">
                <div class="main-container container-fluid">
                    <div class="page-header">
                        <h1 class="page-title">Registrar Usuario Asistente Social</h1>
                        <div>
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Registrar Usuario Asistente Social</li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xl-12">
                            <div class="card overflow-hidden">
                                <div class="card-header bg-primary text-white">
                                    <h3 class="card-title text-white">Formulario de Registro de Usuario Asistente Social</h3>
                                </div>
                                <div class="card-body">
                                    ...
                                    <form action="{{ route('admin.store-asistente-social') }}" method="POST" id="registerAsistenteSocialForm" novalidate>
                                        @csrf
                                            ...
                                            <div class="tab-pane fade" id="datosUsuario" role="tabpanel" aria-labelledby="datos-usuario-tab">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 mb-3">
                                                        ...
                                                        {{-- Este es el campo clave. 'readonly' es correcto. El valor se asigna por JS. --}}
                                                    ...
                                                    <div class="col-md-6 mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="id_rol_display" value="Usuario Asistente Social" readonly>
                                                        <input type="hidden" name="id_rol" value="4"> {{-- Rol Asistente Social --}}
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-6 mb-3">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const form = document.getElementById('registerAsistenteSocialForm');
    ...
    function updateCiUsuario() {
        if (ciInput && ciUsuarioInput) {
            ...
            console.log(`updateCiUsuario: CI Origen = "${ciInput.value}", Usuario (CI) Destino = "${ciUsuarioInput.value}"`);
        } else {
            if (!ciInput) console.error('Error en updateCiUsuario: No se encontró el campo de origen con id="ci".');
            if (!ciUsuarioInput) console.error('Error en updateCiUsuario: No se encontró el campo de destino con id="ci_usuario".');
        }
    }
    ...
    if (ciInput) {
        ciInput.addEventListener('input', function() {
            console.log(`Evento "input" en campo CI (origen). Valor actual: "${this.value}"`);
            updateCiUsuario();
        });
    }
    ...
    if (datosUsuarioTabEl) {
        datosUsuarioTabEl.addEventListener('shown.bs.tab', function () {
            console.log('Evento "shown.bs.tab" para datosUsuarioTabEl disparado. Llamando updateCiUsuario().');
            updateCiUsuario();
        });
    }
    ...
    form.addEventListener('submit', function(event) {
        ...
        if (!allValid) {
            ...
            // Descomentar form.submit() si desea el envío real:
            setTimeout(() => {
