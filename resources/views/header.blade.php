            ...
            <div class="app-header header sticky">
                <div class="container-fluid main-container">
                    <div class="d-flex">
                        ...
                        {{-- ===================== CAMBIO 1 ===================== --}}
                        {{-- Apunta al dashboard del rol actual para evitar el bucle --}}
                        <a class="logo-horizontal " href="{{ Auth::check() ? route(Auth::user()->rol->nombre_rol . '.dashboard') : '#' }}">
            ...
            <div class="sticky">
                ...
                <div class="app-sidebar">
                    <div class="side-header">
                         {{-- ===================== CAMBIO 2 ===================== --}}
                        <a class="header-brand1" href="{{ Auth::check() ? route(Auth::user()->rol->nombre_rol . '.dashboard') : '#' }}">
                    ...
                    <div class="main-sidemenu">
                        ...
                        @auth
                            ...
                            <ul class="side-menu">
                                ...
                                {{-- RESTO DE LA LÓGICA DEL MENÚ DINÁMICO (YA ESTÁ BIEN) --}}
                                @if($rol == 'admin')
